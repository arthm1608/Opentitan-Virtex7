...
// MODIFIED MANUALLY FOR VIRTEX-7 XC7VX690T (VC709) PORT. 
// Original generation command: util/topgen.py -t hw/top_earlgrey/data/top_earlgrey.hjson
// -----------------------------------------------------------------------------------------------//

module chip_earlgrey_virtex7 #(
  // Path to a VMEM file containing the contents of the boot ROM, which will be
  // baked into the FPGA bitstream.
  parameter BootRomInitFile = "test_rom_fpga_virtex7.32.vmem",
  // Path to a VMEM file containing the contents of the emulated OTP, which will be
  // baked into the FPGA bitstream.
  parameter OtpMacroMemInitFile = "otp_img_fpga_virtex7.vmem"
) (
  // Differential Clock Input for Virtex-7 VC709
  input wire IO_CLK_P,
  input wire IO_CLK_N,
  ...
  // Converts Virtex-7 LVDS pins to OpenTitan's internal wire
  // =========================================================
  wire IO_CLK;
  IBUFGDS sys_clk_buf (
    .I  (IO_CLK_P),
...
`endif
  ...
  /////////////////////////////////////////////////////
  // Virtex-7 Tie-Offs for unused Manual Pads        //
  /////////////////////////////////////////////////////
...
endmodule : chip_earlgrey_virtex7